...
public partial class MainLayout : MainLayoutBase
{
    internal override IEnumerable<NavItem> GetNavItems()
    {
        navItems ??= new List<NavItem>
        {
            ...
            new (){ Id = "406", Text = "Text Input", Href = "/form/textInput", IconName = IconName.InputCursorText, ParentId = "4" },
            new (){ Id = "407", Text = "Time Input", Href = "/form/time-input", IconName = IconName.ClockFill, ParentId = "4" },
            new (){ Id = "408", Text = "Validation", Href = "/form/validation", IconName = IconName.ExclamationCircleFill, ParentId = "4" },
